i.e. how this site was built. Inspired by `/colophon` from [[DRAFT "slash pages"|DRAFT "slash pages"]].
...
[Quartz](https://quartz.jzhao.xyz/) transforms Markdown files into HTML. Think of it as of a front-end.
## Obsidian Plugins
